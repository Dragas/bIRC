...
class AuditLogChangeAdapter : JsonDeserializer<AuditLogChange<*>>
{
    ...
    override fun deserialize(json: JsonElement, typeOfT: Type, context: JsonDeserializationContext): AuditLogChange<*>
    {
        ...
        when (returnable.key)
        {
            ...
            {
                returnable.oldValue = context.deserialize<String>(pojo["old_value"], String::class.java)
                returnable.newValue = context.deserialize<String>(pojo["new_value"], String::class.java)
            }
            ...
            {
                returnable.oldValue = context.deserialize<Int>(pojo["old_value"], Int::class.java)
                returnable.newValue = context.deserialize<Int>(pojo["new_value"], Int::class.java)
            }
            ...
            AuditLogChangeKey.ADD ->
            {
                ...
                {}.rawType
                returnable.oldValue = context.deserialize<ArrayList<Role>>(pojo["old_value"], typetoken)
                returnable.newValue = context.deserialize<ArrayList<Role>>(pojo["new_value"], typetoken)
            }
            ...
            {
                returnable.oldValue = context.deserialize<Boolean>(pojo["old_value"], Boolean::class.java)
                returnable.newValue = context.deserialize<Boolean>(pojo["new_value"], Boolean::class.java)
            }
            ...
            AuditLogChangeKey.PERMISSION_OVERWRITES ->
            {
                ...
                {}.rawType
                returnable.oldValue = context.deserialize<ArrayList<Overwrite>>(pojo["old_value"], typetoken)
                returnable.newValue = context.deserialize<ArrayList<Overwrite>>(pojo["new_value"], typetoken)
            }
