...
open class IrcRouter : Router<Request, Response>()
{
    ...
    @Deprecated("Use Command object and Reply object instead")
    companion object
    {
        @Deprecated("Use Command object instead", ReplaceWith("Command.MESSAGE"))
        @JvmStatic
        val MESSAGE: String = Command.PRIVMSG
        @Deprecated("Use Command object instead", ReplaceWith("Command.PRIVATE_MESSAGE"))
        @JvmStatic
        val PRIVATE_MESSAGE = Command.PRIVATE_MESSAGE
        @Deprecated("Use Command object instead", ReplaceWith("Command.CHANNEL_MESSAGE"))
        @JvmStatic
        val CHANNEL_MESSAGE = Command.CHANNEL_MESSAGE
        @Deprecated("Use Command object instead", ReplaceWith("Command.PING"))
        @JvmStatic
         ...
         */
        @Deprecated("Use Reply object instead", ReplaceWith("Reply.RPL_ISUPPORT"))
        @JvmStatic
        val RPL_ISUPPRORT = Reply.RPL_ISUPPRORT // According to RFC 2812 005 means RPL_BOUNCE, but servers use it as RPL_ISUPPORT?
    }
